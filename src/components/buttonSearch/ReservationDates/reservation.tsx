...
export function Reservation (){
    ...
    return(
       <div className="md:w-1/2 md:h-2/4 md:flex md:absolute md:top-36 md:mt-2 md:rounded-3xl md:left-1/4 md:z-20 md:bg-white md:shadow-lg md:shadow-black md:justify-center">
            <ButtonDates />
