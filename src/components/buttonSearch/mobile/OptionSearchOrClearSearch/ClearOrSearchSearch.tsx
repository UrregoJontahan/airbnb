...
export function OptionClearOrSearch (){
    ...
    const {openReservation,suggestionsAddress} = useStore()

    return (
        <div className={`absolute bottom-0 w-full p-4 border-t border-gray-300 ${openReservation && "hidden"} ${suggestionsAddress && "hidden"}`}>
