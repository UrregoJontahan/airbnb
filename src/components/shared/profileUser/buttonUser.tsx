...
export function ButtonUser(){
    ...
    return(
            <div>
            <div className="flex w-20 h-12 rounded-full border border-gray-400 mr-20 mt-4 items-center justify-center gap-2 hover:shadow-md cursor-pointer" onClick={handleOpenBoxUser}>
